package com.bgsoftware.superiorskyblock.plot.upgrade;
...
public class SUpgradeLevel implements UpgradeLevel {
    ...
    private final Map<PotionEffectType, Integer> plotEffects;
    ...
    public SUpgradeLevel(int level, UpgradeCost cost, List<String> commands, String permission, Set<UpgradeRequirement> requirements,
                         ...
                         Map<PotionEffectType, Integer> plotEffects, Value<BigDecimal> bankLimit,
    ...
    public int getPotionEffect(PotionEffectType potionEffectType) {
        ...
        return plotEffects.getOrDefault(potionEffectType, 0);
    }

    @Override
    public Map<PotionEffectType, Integer> getPotionEffects() {
        return Collections.unmodifiableMap(plotEffects);
    }
    ...
    public Map<PotionEffectType, Value<Integer>> getPotionEffectsUpgradeValue() {
        return plotEffects.entrySet().stream().collect(Collectors.toMap(
                Map.Entry::getKey,
                entry -> Value.syncedFixed(entry.getValue()))
        );
    }
