...
public enum Message {
    ...
    CHANGED_PLOT_EFFECT_LEVEL,
    CHANGED_PLOT_EFFECT_LEVEL_ALL,
    CHANGED_PLOT_EFFECT_LEVEL_NAME,
    CHANGED_PLOT_SIZE,
    CHANGED_PLOT_SIZE_ALL,
    CHANGED_PLOT_SIZE_BUILD_OUTSIDE,
    CHANGED_PLOT_SIZE_NAME,
    CHANGED_LANGUAGE,
    CHANGED_MOB_DROPS,
    ...
    DEPOSIT_ERROR,
    DESTROY_OUTSIDE_PLOT,
    DISBANDED_PLOT,
    DISBANDED_PLOT_OTHER,
    DISBANDED_PLOT_OTHER_NAME,
    DISBAND_ANNOUNCEMENT,
    DISBAND_GIVE,
    DISBAND_GIVE_ALL,
    DISBAND_GIVE_OTHER,
    DISBAND_PLOT_BALANCE_REFUND,
    DISBAND_SET,
    DISBAND_SET_ALL,
    DISBAND_SET_OTHER,
    ENTER_PVP_PLOT,
    ...
    INVALID_INTERVAL,
    INVALID_PLOT,
    INVALID_PLOT_LOCATION,
    INVALID_PLOT_OTHER,
    INVALID_PLOT_OTHER_NAME,
    ...
    PLOT_BANK_EMPTY,
    PLOT_BANK_SHOW,
    PLOT_BANK_SHOW_OTHER,
    PLOT_BANK_SHOW_OTHER_NAME,
    PLOT_BEING_CALCULATED,
    PLOT_CLOSED,
    PLOT_CREATE_PROCCESS_REQUEST,
    PLOT_CREATE_PROCESS_FAIL,
    PLOT_FLY_DISABLED,
    PLOT_FLY_ENABLED,
    PLOT_GOT_DELETED_WHILE_INSIDE,
    PLOT_GOT_PVP_ENABLED_WHILE_INSIDE,
    PLOT_HELP_FOOTER,
    PLOT_HELP_HEADER,
    PLOT_HELP_LINE,
    PLOT_HELP_NEXT_PAGE,
    PLOT_INFO_ADMIN_BANK_LIMIT,
    PLOT_INFO_ADMIN_BLOCKS_LIMITS,
    PLOT_INFO_ADMIN_BLOCKS_LIMITS_LINE,
    PLOT_INFO_ADMIN_COOP_LIMIT,
    PLOT_INFO_ADMIN_CROPS_MULTIPLIER,
    PLOT_INFO_ADMIN_DROPS_MULTIPLIER,
    PLOT_INFO_ADMIN_ENTITIES_LIMITS,
    PLOT_INFO_ADMIN_ENTITIES_LIMITS_LINE,
    PLOT_INFO_ADMIN_GENERATOR_RATES,
    PLOT_INFO_ADMIN_GENERATOR_RATES_LINE,
    PLOT_INFO_ADMIN_PLOT_EFFECTS,
    PLOT_INFO_ADMIN_PLOT_EFFECTS_LINE,
    PLOT_INFO_ADMIN_ROLE_LIMITS,
    PLOT_INFO_ADMIN_ROLE_LIMITS_LINE,
    PLOT_INFO_ADMIN_SIZE,
    PLOT_INFO_ADMIN_SPAWNERS_MULTIPLIER,
    PLOT_INFO_ADMIN_TEAM_LIMIT,
    PLOT_INFO_ADMIN_UPGRADES,
    PLOT_INFO_ADMIN_UPGRADE_LINE,
    PLOT_INFO_ADMIN_VALUE_SYNCED,
    PLOT_INFO_ADMIN_WARPS_LIMIT,
    PLOT_INFO_BANK,
    PLOT_INFO_BONUS,
    PLOT_INFO_BONUS_LEVEL,
    PLOT_INFO_CREATION_TIME,
    PLOT_INFO_DISCORD,
    PLOT_INFO_FOOTER,
    PLOT_INFO_HEADER,
    PLOT_INFO_LAST_TIME_UPDATED,
    PLOT_INFO_LAST_TIME_UPDATED_CURRENTLY_ACTIVE,
    PLOT_INFO_LEVEL,
    PLOT_INFO_LOCATION,
    PLOT_INFO_NAME,
    PLOT_INFO_OWNER,
    PLOT_INFO_PAYPAL,
    PLOT_INFO_PLAYER_LINE,
    PLOT_INFO_RATE,
    PLOT_INFO_RATE_EMPTY_SYMBOL,
    PLOT_INFO_RATE_FIVE_COLOR,
    PLOT_INFO_RATE_FOUR_COLOR,
    PLOT_INFO_RATE_ONE_COLOR,
    PLOT_INFO_RATE_SYMBOL,
    PLOT_INFO_RATE_THREE_COLOR,
    PLOT_INFO_RATE_TWO_COLOR,
    PLOT_INFO_ROLES,
    PLOT_INFO_VISITORS_COUNT,
    PLOT_INFO_WORTH,
    PLOT_OPENED,
    PLOT_PREVIEW_CANCEL,
    PLOT_PREVIEW_CANCEL_DISTANCE,
    PLOT_PREVIEW_CANCEL_TEXT,
    PLOT_PREVIEW_CONFIRM_TEXT,
    PLOT_PREVIEW_START,
    PLOT_PROTECTED,
    PLOT_PROTECTED_OPPED,
    PLOT_TEAM_STATUS_FOOTER,
    PLOT_TEAM_STATUS_HEADER,
    PLOT_TEAM_STATUS_OFFLINE,
    PLOT_TEAM_STATUS_ONLINE,
    PLOT_TEAM_STATUS_ROLES,
    PLOT_TOP_STATUS_OFFLINE,
    PLOT_TOP_STATUS_ONLINE,
    PLOT_WARP_PRIVATE,
    PLOT_WARP_PUBLIC,
    PLOT_WAS_CLOSED,
    PLOT_WORTH_ERROR,
    ...
    RATE_OWN_PLOT,
    RATE_REMOVE_ALL,
    RATE_REMOVE_ALL_PLOTS,
    RATE_SUCCESS,
    REACHED_BLOCK_LIMIT,
    RECALC_ALL_PLOTS,
    RECALC_ALL_PLOTS_DONE,
    ...
    TELEPORT_LOCATION_OUTSIDE_PLOT,
    TELEPORT_OUTSIDE_PLOT,
    TELEPORT_WARMUP,
    ...
    PROTECTION(true) {
        ...
        public void send(CommandSender sender, Locale locale, Object... args) {
            ...
            if (noInteractMessages.add(playerUUID)) {
                Message.PLOT_PROTECTED.send(sender, locale, args);
                ...
                if (bypassCommand != null && sender.hasPermission(bypassCommand.getPermission()))
                    Message.PLOT_PROTECTED_OPPED.send(sender, locale, args);
            }
        }
    },
