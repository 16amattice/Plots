...
public class PlotArea {
    ...
    public PlotArea(BlockPosition center, int size) {
        this(center.getX() - size, center.getZ() - size, center.getX() + size, center.getZ() + size);
    }

    public PlotArea(int minX, int minZ, int maxX, int maxZ) {
        this.minX = minX;
        this.minZ = minZ;
        this.maxX = maxX;
        this.maxZ = maxZ;
    ...
    public PlotArea copy() {
        return new PlotArea(this.minX, this.minZ, this.maxX, this.maxZ);
    }
