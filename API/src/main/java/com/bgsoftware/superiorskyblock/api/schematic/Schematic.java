...
public interface Schematic {
     ...
     *
     * @param plot   The plot of the schematic.
     ...
     */
    void pasteSchematic(Plot plot, Location location, Runnable callback);
     ...
     */
    void pasteSchematic(Plot plot, Location location, Runnable callback, @Nullable Consumer<Throwable> onFailure);
